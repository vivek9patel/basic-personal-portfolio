...
const ThemeSelectorLazy: React.FC<ThemeSelectorLazyProps> = ({ compact = false }) => {
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            <div className="text-left">
              ...
              <div className="text-xs text-muted-foreground capitalize">{theme.name}</div>
            </div>
          </div>
          ...
          {(isLoading || isLoadingTheme) && currentTheme?.name === theme.name && (
